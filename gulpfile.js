...
gulp.task('rename', function ()  {
    var newname;
    var author = '@@Author@@';
    var email  = 'frank.hirsch@mac.com';
    ...
    if (!newname) {
        console.log('Please write the new etamon name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/etamon.png')) {
        fs.renameSync(__dirname + '/admin/etamon.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/etamon.html')) {
        fs.renameSync(__dirname + '/widgets/etamon.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/etamon/js/etamon.js')) {
        fs.renameSync(__dirname + '/widgets/etamon/js/etamon.js', __dirname + '/widgets/etamon/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/etamon')) {
        fs.renameSync(__dirname + '/widgets/etamon',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /etamon/g,
        ...
        {
            match: /Etamon/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Etamon'
        },
        {
            match: /@@Author@@/g,
            replacement: author
